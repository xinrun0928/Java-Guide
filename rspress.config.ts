...
const siteMeta = {
  ...
  title: 'Java-Guide',
  /** 网站描述 - 用于 SEO 搜索引擎优化 */
  description: '系统化 Java 后端知识体系与面试指南，覆盖 JVM、并发、Spring、MySQL、Redis、分布式架构及高频面试题',
  /** 作者信息 */
  author: 'Mr.zhang',
  ...
  keywords: [
    ...
    // 计算机基础
    '计算机网络', 'TCP', 'IP', 'HTTP', 'HTTPS', '操作系统', '进程', '线程', '内存管理', 'IO模型', '网络安全', '加密算法', '数据结构', '算法',
    // Java 核心
 ...
 * GitHub 仓库地址
 */
const gitHubRepo = 'https://github.com/xinrun0928/Java-Guide';
...
export default defineConfig({
  ...
  themeConfig: {
     ...
     */
    footer: {
      message: `Copyright © 2025-2026 <a href="${gitHubRepo}">Java-Guide</a>`,
    }
  },
